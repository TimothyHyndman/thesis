...
\begin{proof}
	...
	\end{align}
	We note that we can represent each vertex in the positive orthant within distance $k$ of the origin by $k$ stars separated by $n$ bars, and taking $x_i$ to be the number of stars between bars $i-1$ and $i$. So for example, if $k = 5$ and $d = 2$,
	\begin{equation}
