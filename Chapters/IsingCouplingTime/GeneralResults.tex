...
% \end{proof}
\begin{lemma}
	There exists a constant $C_2 > 0$ and for any $0 < \epsilon < 1$, there exists a constant $C_1 > 0$ such that for sufficiently small $\beta$,
	\label{lem:nd X_j given X_i}
	\begin{equation}
		\prob[X_j = 1| X_i = 1] \leq C_{z, \epsilon} C_1 n^{-\epsilon} + C_2 \euler^{-k}.
	\end{equation}
