...
\lhead{Chapter \ref{Ch:1D}. \emph{The Coupling Time on the Cycle}}
	...
	The proof of Theorem \ref{thm:Coupling Distribution on Cycle} is the subject of Section \ref{sec:proof thm coupling cycle}. 

	On the cycle, the heat-bath dynamics allow for a new set of updates rules that do not change the distribution of $T_n$ and result in update histories which do not branch out to multiple vertices.
