...
\section{Coupling from the Past}
	...
	\begin{proof}
		...
		\end{align}
		Since $a_n/b_n \rightarrow 0$, for large enough $n$ we have $a_n < b_n$. We can then use that $x \leq \exp(x) - 1$ for $0 \leq x \leq 1$ to show that
		\begin{align}
		...
		\end{align}
		where we have again used that for large enough $n$, $a_n < b_n$. By \eqref{eq:m_n a_n b_n constraint}, this goes to zero as $n \rightarrow \infty$.

		To bound the second term, we will treat the two directions of the proof separately. Firstly, assume that $Z_n \convergedist X$. Then note that
		\begin{align}
		...
		\end{align}
		As above, since $a_n/b_n \rightarrow \infty$, and $Y_n$ converges, the first term vanishes in the limit, and the second disappears since 
		\begin{equation}
