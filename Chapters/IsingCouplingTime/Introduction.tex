...
\section{Coupling from the Past}
	...
	\label{claim:discrete vs continuous distributions}
		...
		Let $a_n$ and $b_n$ be positive deterministic sequences such that $b_n / a_n \rightarrow \infty$ and for any $c > 0$
		\begin{equation}
			\frac{m_n a_n^2}{b_n^2} - c \log\frac{b_n}{a_n} \rightarrow \infty.
