...
\section{Coupling from the Past}
	...
	\label{claim:discrete vs continuous distributions}
		...
		Let $a_n$ and $b_n$ be positive deterministic sequences such that $b_n / a_n \rightarrow \infty$ and for any $\epsilon > 0$
		\begin{equation}
			\epsilon \frac{m_n a_n^2}{b_n^2} - \log\frac{b_n^2}{a_n^2} \rightarrow \infty.
	...
	\begin{proof}
		...
		\end{align}
		Since $x \leq \exp(x) - 1$ for $0 \leq x \leq 1$, for sufficiently large $n$,
		\begin{align}
