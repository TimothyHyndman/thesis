...
\section{Coupling from the Past}
	...
	\begin{proof}
		...
		So 
		\begin{align}
			L = \lim_{n \rightarrow \infty} \prob(N(T_n) < \lambda w_n)
		\end{align}
	\end{proof}
	...
	The state $F_{-k}(\mathscr{B}_0) = F_{-k}(\mathscr{T}_0)$ is the output of the CFTP algorithm, and is an exact sample from the Gibbs measure \eqref{eq:gibbsmeasure}.
