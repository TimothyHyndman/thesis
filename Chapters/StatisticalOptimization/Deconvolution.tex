...
\section{Introduction}
	...
	The problem is one of \emph{deconvolution}, the recovery of the distribution of some variable $X$ when we can only measure 
	\begin{equation}
		W = X+U
	\end{equation}
	where $U$ represents some measurement error.
