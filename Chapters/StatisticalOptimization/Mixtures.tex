...
\label{sec:empirical results}
	...
	\end{equation}
	the gradient function defined in \eqref{eq:def gradient function}, evaluated at a mixture $Q$ which places masses $\vect{p}$ at locations $\vect{\theta}$, can be written as
	\begin{equation}
		D_Q(\theta; \vect{x}, f) = n - \sum_{i = 1}^n\Gamma_k(\theta;\vect{\theta},\vect{p})
	\end{equation}
