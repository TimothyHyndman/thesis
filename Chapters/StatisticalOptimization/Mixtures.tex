...
\section{Summary of Lindsay}
	...
	\subsection{An example}
		...
		The following example illustrates the geometrical approach given above. We consider the case where $n = 2$. Our sample is made up of two points, $X_1 = 1$ and $X_2 = 2$. We define the normal density with variance $\sigma_2 = 0.45^2$ and parametrized by $\theta$,
		\begin{equation}
		f_\theta(x) = \frac{1}{0.45 \sqrt{2 \pi}} \exp\left(-\frac{(x-\theta)^2}{2\cdot 0.45^2}\right)
		\end{equation}
		to be our component density.
