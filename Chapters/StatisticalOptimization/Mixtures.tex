...
\section{Introduction}
	...
	The size of the support of the $Q$ that maximizes \eqref{eq:loglikelihood} is the primary quantity of interest for this Chapter. However, there are a few considerations to be made. The first is that there is not necessarily a unique mixing distribution that maximizes \eqref{eq:loglikelihood}. This does not pose a huge problem for us as we can choose to consider the smallest number of points of support required for a maximizing distribution. The question of uniqueness was addressed by Lindsay in \cite{Lindsay1983-tf} and in \cite{Lindsay1983a-he} for univariate component density univariate in the exponential family.
