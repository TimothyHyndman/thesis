...
\label{sec:summary of Lindsay}
	...
	\begin{figure}
		...
		\caption{The likelihood curve along with the support hyperplane, $\mathcal{H}_{\hat{Q}}$, that contains $\hat{\vect{\gamma}}$. The support line has two points of contact with $\vect{\gamma}$ which correspond to the two points of support of the maximum likelihood mixture $\hat{Q}$. In this example $\vect{x} = (1,2)$ and $f$ is a Cauchy density with scale parameter $1/2$.}
